                  ...
                  <Stack vertical>
                    ...
                    <Dropdown
                      ...
                      displayText={
                        ...
                        style={{
                          color:
                            data.species_selected?.toLowerCase().includes('synth') ||
                            data.selected_faction?.toLowerCase().includes('working joe')
                              ? 'blue'
                              : data.species_selected?.toLowerCase().includes('unggoy')
                                ? 'orange'
                                : data.species_selected?.toLowerCase().includes('sangheili')
                                  ? 'red'
