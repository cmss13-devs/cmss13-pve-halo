...
#define SHIP_MAP_NAMES list("USS Almayer", "USS Golden Arrow",  "USS Golden Arrow (Classic)", "SSV Chapaev", "USS Rover", "UNSC Dark Was The Night", "USCSS Firefly", "UNSC Dark Was The Night (ODST Bay)")
