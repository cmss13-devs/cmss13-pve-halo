...
GLOBAL_LIST_INIT(first_names_male_brazilian, list("José", "João", "Antônio", "Francisco", "Carlos", "Paulo", "Pedro", "Lucas", "Luíz", "Marcos", "Gabriel", "Marcelo", "Rafael", "Bruno", "Eduardo", "Ravi", "Théo", "Heitor", "Bernardo", "Joaquim", "Nicolau", "Henrique", "Felipe", "Lourenço", "Natã", "Enzo", "Otávio", "Vitor", "Valentim", "Guilherme", "Enrico", "Dante", "Raimundo", "André", "Manoel", "Alexandre", "Sebastião", "Cláudio", "Ronaldo", "Luciano", "Adriano"))
GLOBAL_LIST_INIT(first_names_female_brazilian, list("Maria", "Ana", "Francisca", "Antônia", "Adriana", "Juliana", "Márcia", "Fernanda", "Patricia", "Aline", "Sandra", "Camila", "Amanda", "Jéssica", "Letícia", "Júlia", "Mariana", "Gabriela", "Beatriz", "Sónia", "Simone", "Rosângela", "Marlene", "Terezinha", "Ângela", "Isabel", "Maitê", "Antonela", "Maia", "Yasmin"))
GLOBAL_LIST_INIT(last_names_brazilian, list("Silva", "Santos", "Oliveira", "Souza", "Sousa", "Rodrigues", "Ferreira", "Alves", "Pereira", "Lima", "Costa", "Gomes", "Ribeiro", "Martins", "Carvalho", "Almeida", "Lopes", "Soares", "Fernandes", "Vieira", "Barbosa", "Rocha", "Dias", "Nascimento", "Andrade", "Moreira", "Nunes", "Marques", "Machado", "Mendes", "Freitas", "Cardoso", "Ramos", "Gonçalves", "Santana", "Teixeira"))
...
GLOBAL_LIST_INIT(first_names_spartan, list("James","Harry","Kim","Leon","Nick","Will","Tom","Steven","Samuel","Kirk","August","Charles","Elen","Nook","Cindy","Soren","Shane","Charlie","Kelly","Ted","Joe","Joseph","Anderson","Seth","Jeremy","Ethan","Shaw","Robin","Thorne","Edd","Brendan","Billy","Cameron","Mandy","Shina","Mike","Jeffery","Palmer","Bretta","Tanya","Sasha","Myla","Iselda","Allyria","Grace","Lydia","Marissa","Eira","Eva","Alma","Julianne","Sei","Gillian","Dana","Gordon","Lara","Chell","Yang","Dusty","Walter","Oscar","Edwin"))
