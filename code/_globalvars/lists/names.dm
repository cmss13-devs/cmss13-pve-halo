...
GLOBAL_LIST_INIT(first_names_unggoy, list("Bip","Bap","Bam","Brig","Lard","Dim","Kim","Yap","Yip","Yad","Yab","Bug","Yug","Lug","Pom","Yam","Gud","Gun","Dam","Flim","Flum","Flop","Flo","Stol","Kwas","Pig"))
GLOBAL_LIST_INIT(last_names_unggoy, list("bip","bap","bam","brig","lard","dim","kim","yap","yip","yad","yab","bug","yug","lug","pom","yam","gud","gun","dam","flim","flum","flop","flo","stol","kwas","pig","ass"))
