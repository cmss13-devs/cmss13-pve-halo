...
/atom/proc/langchat_make_image(override_color = null)
	if(!langchat_image)
		...
		langchat_image.appearance_flags = NO_CLIENT_COLOR|KEEP_APART|RESET_COLOR|RESET_TRANSFORM|APPEARANCE_UI_IGNORE_ALPHA //Means that emotes/speech whilst invisible will be visible overhead
