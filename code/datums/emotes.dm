...
/datum/emote
	...
	var/replace_pronouns = TRUE	//Pronoun-autoreplace-B-gone
...
/datum/emote/proc/run_emote(mob/user, params, type_override, intentional = FALSE)
	...
	if(replace_pronouns)
		msg = replace_pronoun(user, msg)	//Pronound-autoreplace-B-gone
...
/datum/emote/proc/run_langchat(mob/user, list/group)
	...
	user.langchat_speech(adjusted_message, group, GLOB.all_languages, skip_language_check = TRUE, additional_styles = list("emote", "langchat_small"))	//More pronoun-autoreplacement stuff
