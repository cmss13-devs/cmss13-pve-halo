...
/obj/docking_port/mobile/dwtn_ventral_cargo_elevator
	name="Cargo Elevator"
...
/obj/docking_port/mobile/dwtn_ventral_cargo_elevator/Initialize(mapload, ...)
	. = ..()
	door_control = new()
	door_control.label = "elevator"
	for(var/area/shuttle_area in shuttle_areas)
...
/obj/docking_port/mobile/dwtn_ventral_cargo_elevator/Destroy(force, ...)
	. = ..()
	QDEL_NULL(door_control)

/obj/docking_port/mobile/dwtn_ventral_cargo_elevator/beforeShuttleMove(turf/newT, rotation, move_mode, obj/docking_port/mobile/moving_dock)
	. = ..()
	door_control.control_doors("force-lock-launch", "all", force=TRUE)

/obj/docking_port/stationary/dwtn_ventral_cargo_elevator
	dir=NORTH
	width=7
	height=6
	// shutters to clear the area
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/proc/get_doors()
	. = list()
	for(var/area/target_area in world)
		if(istype(target_area, airlock_area))
			for(var/obj/structure/machinery/door/door in target_area)
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/on_arrival(obj/docking_port/mobile/arriving_shuttle)
	. = ..()
	// open elevator doors
	if(istype(arriving_shuttle, /obj/docking_port/mobile/dwtn_ventral_cargo_elevator))
		var/obj/docking_port/mobile/dwtn_ventral_cargo_elevator/elevator = arriving_shuttle
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/on_departure(obj/docking_port/mobile/departing_shuttle)
	. = ..()
	var/datum/door_controller/single/door_control = new()
	door_control.doors = get_doors()
	door_control.control_doors("force-lock-launch")
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/occupied
	name = "occupied"
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/empty
	name = "empty"
	id = STAT_DWTN_VENTRAL_EMPTY
	airlock_exit = "dwtn_ventral"

/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/arrival
	name = "Upper Level"
...
/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/exit
	name = "Lower Level"
...
/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/get_landing_zones()
	. = list()
	var/obj/docking_port/mobile/dwtn_ventral_cargo_elevator/shuttle = SSshuttle.getShuttle(shuttleId)

	for(var/obj/docking_port/stationary/dwtn_ventral_cargo_elevator/elev in SSshuttle.stationary)
		if(!shuttle.elevator_network)
			. += list(elev)
			continue
		if(shuttle.elevator_network == elev.elevator_network)
...
/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call
	name = "\improper Elevator Call"
	desc = "Control panel for the elevator."
...
/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call/get_landing_zones()
	return list(SSshuttle.getDock(dockId))

/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call/dwtn_ventral_cargo_elevator/occupied
	dockId = STAT_DWTN_VENTRAL_OCCUPIED

/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call/dwtn_ventral_cargo_elevator/empty
	dockId = STAT_DWTN_VENTRAL_EMPTY

/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call/dwtn_ventral_cargo_elevator/arrival
	dockId = STAT_DWTN_VENTRAL_ELEVATOR

/obj/structure/machinery/computer/shuttle/elevator_controller/dwtn_ventral_cargo_elevator/elevator_call/dwtn_ventral_cargo_elevator/exit
