...
/obj/item/clothing/suit/marine/unsc
	...
	icon = 'icons/halo/obj/items/clothing/suits/suits by faction/suit_unsc.dmi'
	icon_state = "m52b"
	item_state = "m52b"
	flags_atom = NO_SNOW_TYPE|NO_NAME_OVERRIDE
	item_icons = list(
		WEAR_JACKET = 'icons/halo/mob/humans/onmob/clothing/suits/suits by faction/suit_unsc.dmi')
