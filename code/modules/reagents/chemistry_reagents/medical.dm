...
/datum/reagent/medical/biofoam
	...
	overdose_critical = MED_REAGENTS_OVERDOSE_CRITICAL
	chemclass = CHEM_CLASS_UNCOMMON
	properties = list(PROPERTY_CARDIOSTABILIZING = 3, PROPERTY_PAINKILLING = 5, PROPERTY_NEOGENETIC = 1, PROPERTY_ANTICORROSIVE = 1, PROPERTY_ORGANSTABILIZE = 4, PROPERTY_INTRAVENOUS = 1, PROPERTY_HEMOSTATIC = 1, PROPERTY_OXYGENATING = 5)
	custom_metabolism = AMOUNT_PER_TIME(1, 40 SECONDS)
...
/datum/reagent/medical/biofoam/lite
	...
	overdose_critical = HIGH_REAGENTS_OVERDOSE_CRITICAL
	chemclass = CHEM_CLASS_UNCOMMON
	properties = list(PROPERTY_CARDIOSTABILIZING = 2, PROPERTY_PAINKILLING = 3, PROPERTY_INTRAVENOUS = 1, PROPERTY_HEMOSTATIC = 1, PROPERTY_OXYGENATING = 2)
