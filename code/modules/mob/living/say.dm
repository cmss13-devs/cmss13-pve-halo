GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	":4" = SQUAD_COVENANT, ".4" = SQUAD_COVENANT, "#4" = SQUAD_COVENANT,
	":5" = SQUAD_COVENANT_2, ".5" = SQUAD_COVENANT_2, "#5" = SQUAD_COVENANT_2,
	":6" = RADIO_CHANNEL_COV_CMD, ".6" = RADIO_CHANNEL_COV_CMD, "#6" = RADIO_CHANNEL_COV_CMD,
