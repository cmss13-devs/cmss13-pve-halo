...
/datum/species/sangheili/handle_post_spawn(mob/living/carbon/human/sangheili)
	...
	give_action(sangheili, /datum/action/human_action/activable/fling)
	give_action(sangheili, /datum/action/human_action/activable/punch)
	give_action(sangheili, /datum/action/human_action/activable/strength)
	...
	sangheili.AddComponent(/datum/component/jump, _jump_duration = 0.75 SECONDS, _jump_cooldown = 1 SECONDS, _jump_height = 32, _jump_sound = 'sound/weapons/thudswoosh.ogg', _jump_flags = JUMP_SPIN, _jumper_allow_pass_flags = PASS_OVER|PASS_MOB_THRU)
