...
/datum/equipment_preset/proc/add_marine_uniform(mob/living/carbon/human/new_human) // if we ever have different unforms in the future, this is setup to handle that
	if(!istype(new_human))
		return
	var/obj/item/clothing/under/marine/standard/uniform = new()
...
/datum/equipment_preset/proc/add_rifleman_gear(mob/living/carbon/human/new_human)
	...
	new_human.equip_to_slot_or_del(new /obj/item/storage/box/mre(new_human), WEAR_IN_BACK)
	// Jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/storage/webbing/m52b/grenade/mix_nades(new_human), WEAR_ACCESSORY)
	// Pockets
...
/datum/equipment_preset/proc/add_officer_gear(mob/living/carbon/human/new_human)
	if(!istype(new_human))
		return
	// Head & Face
	new_human.equip_to_slot_or_del(new /obj/item/device/radio/headset/almayer/marine/solardevils/unsc(new_human), WEAR_L_EAR)
...
/datum/equipment_preset/proc/add_odst_uniform(mob/living/carbon/human/new_human)
	if(!istype(new_human))
		return
...
/datum/equipment_preset/proc/add_odst_rifleman_gear(mob/living/carbon/human/new_human)
	...
	// Jacket
	new_human.equip_to_slot_or_del(new /obj/item/clothing/accessory/storage/webbing/m52b/grenade/mix_odst_nades(new_human), WEAR_ACCESSORY)
	// Back
	new_human.equip_to_slot_or_del(new /obj/item/storage/backpack/marine/satchel/unsc(new_human), WEAR_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/box/mre(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/box/flare(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/storage/box/tear_packet/medical_packet(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/halo/m6c/socom(new_human), WEAR_IN_BACK)
	new_human.equip_to_slot_or_del(new /obj/item/ammo_magazine/pistol/halo/m6c/socom(new_human), WEAR_IN_BACK)
	// Pockets
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/first_responder/unsc(new_human), WEAR_L_STORE)
	new_human.equip_to_slot_or_del(new /obj/item/storage/pouch/pistol/unsc(new_human), WEAR_R_STORE)
...
/datum/equipment_preset/proc/add_ma5b_package_alt(mob/living/carbon/human/new_human)
	if(!istype(new_human))
		return
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/halo/ma5b(new_human), WEAR_J_STORE)
...
/datum/equipment_preset/proc/add_ma5c_package_alt(mob/living/carbon/human/new_human)
	if(!istype(new_human))
		return
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/halo/ma5c(new_human), WEAR_J_STORE)
...
/datum/equipment_preset/proc/add_br55_package_alt(mob/living/carbon/human/new_human)
	if(!istype(new_human))
		return
	new_human.equip_to_slot_or_del(new /obj/item/weapon/gun/rifle/halo/br55(new_human), WEAR_J_STORE)
