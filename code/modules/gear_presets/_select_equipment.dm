...
/datum/equipment_preset/proc/load_dodgeroll(mob/living/carbon/human/new_human)
	...
	new_human.dodge_pool_regen_enabled = new_human.species.dodge_pool_regen_enabled
