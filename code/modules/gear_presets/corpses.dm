...
/datum/equipment_preset/corpse/wy_rsr
	name = "Corpse - Weyland-Yutani Researcher"
	assignment = "Weyland-Yutani Researcher"
	xenovictim = FALSE

/datum/equipment_preset/corpse/wy_rsr/load_gear(mob/living/carbon/human/new_human)
