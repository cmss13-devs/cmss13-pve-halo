...
/obj/item/storage/box/uscm_mre
	name = "\improper UNSC meal ready to eat"
...
/obj/item/reagent_container/food/snacks/mre_pack
	...
	//trash = /obj/item/trash/UNSCtray
	trash = null
	w_class = SIZE_SMALL

/obj/item/reagent_container/food/snacks/mre_pack/meal1
	name = "\improper UNSC Prepared Meal (cornbread)"
	desc = "A tray of standard UNSC food. Stale cornbread, tomato paste and some green goop fill this tray."
	icon_state = "MREa"
	filling_color = "#ED1169"
...
/obj/item/reagent_container/food/snacks/mre_pack/meal2
	name = "\improper UNSC Prepared Meal (pork)"
	desc = "A tray of standard UNSC food. Partially raw pork, goopy corn and some watery mashed potatoes fill this tray."
	icon_state = "MREb"
...
/obj/item/reagent_container/food/snacks/mre_pack/meal3
	name = "\improper UNSC Prepared Meal (pasta)"
	desc = "A tray of standard UNSC food. Overcooked spaghetti, waterlogged carrots and two french fries fill this tray."
	icon_state = "MREc"
...
/obj/item/reagent_container/food/snacks/mre_pack/meal4
	name = "\improper UNSC Prepared Meal (pizza)"
	desc = "A tray of standard UNSC food. Cold pizza, wet green beans and a shitty egg fill this tray. Get something other than pizza, lardass."
	icon_state = "MREd"
...
/obj/item/reagent_container/food/snacks/mre_pack/meal5
	name = "\improper UNSC Prepared Meal (chicken)"
	desc = "A tray of standard UNSC food. Moist chicken, dry rice and a mildly depressed piece of broccoli fill this tray."
	icon_state = "MREe"
...
/obj/item/reagent_container/food/snacks/mre_pack/meal6
	name = "\improper UNSC Prepared Meal (tofu)"
	desc = "The UNSC doesn't serve tofu you grass sucking hippie. The flag signifies your defeat."
	icon_state = "MREf"
...
/obj/item/reagent_container/food/snacks/mre_pack/xmas1
	name = "\improper UNSC M25 'X-MAS' Meal: Sugar Cookies"
	desc = "The UNSC M25 Sugar Cookies Meal was designed to give marines a feeling of Christmas joy. But to the bemusement of superior officers, the costs-savings measure of simply fabricating protein bars in the shape of cookies with chocolate substitute chips and the replacement of the expected milk with artificially colored water did not go over well with most marines."
...
/obj/item/reagent_container/food/snacks/mre_pack/thanksgiving
	name = "\improper UNSC Prepared Meal (turkey)"
	desc = "A tray of standard UNSC food. A few slices of turkey and some regenerated mashed potatos with a rather viscous gravy on top. A classic, if rather half-hearted, Thanksgiving meal."
	icon_state = "MREe"
...
/obj/item/device/overwatch_camera
	name = "M5 Camera Gear"
	desc = "A camera and associated headgear designed to allow marine commanders to see what their troops can see. A more robust version of this equipment is integrated into all standard UNSC combat helmets."
