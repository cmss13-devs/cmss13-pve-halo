...
//Insurgents/Partisans
#define JOB_INSURGENT_PARTISAN "Partisan"
#define JOB_INSURGENT_PARTISAN_LEAD "Partisan Leader"
...
#define INSURGENT_JOB_LIST list(JOB_INSURGENT_PARTISAN, JOB_INSURGENT_PARTISAN_LEAD, JOB_INSURGENT, JOB_INSURGENT_TECHNICIAN, JOB_INSURGENT_SPECIALIST, JOB_INSURGENT_SL, JOB_INSURGENT_LEAD)
