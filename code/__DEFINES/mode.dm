...
GLOBAL_LIST_INIT(ROLES_AI_FORECON, list(JOB_SQUAD_LEADER_FORECON, JOB_SQUAD_MEDIC_FORECON, JOB_SQUAD_TEAM_LEADER_FORECON, JOB_SQUAD_SPECIALIST_FORECON, JOB_SQUAD_MARINE_FORECON, JOB_SQUAD_RTO_FORECON))
