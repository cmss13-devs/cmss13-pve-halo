...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_PMCPLT, SQUAD_PMCPLT_SMALL, SQUAD_RMC, SQUAD_PMCPLT, SQUAD_ODST, SQUAD_UNSC_ODST_COMBO))
...
GLOBAL_LIST_INIT(ROLES_SQUAD_UNSC_ODST_COMBO, list(JOB_SQUAD_MARINE_ODST, JOB_SQUAD_SPECIALIST_ODST, JOB_SQUAD_MEDIC_ODST, JOB_SQUAD_TEAM_LEADER_ODST, JOB_SQUAD_LEADER_ODST, JOB_SQUAD_RTO_ODST, JOB_SQUAD_LEADER, JOB_SQUAD_RTO, JOB_SQUAD_MEDIC, JOB_SQUAD_TEAM_LEADER, JOB_SQUAD_SPECIALIST, JOB_SQUAD_MARINE))
...
#define FACTION_LIST_COVENANT list(FACTION_UNGGOY, FACTION_SANGHEILI, FACTION_KIGYAR)
