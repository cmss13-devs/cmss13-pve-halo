...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/unsc/populate_product_list(scale)
	listed_products = list(
		...
		list("CH252/UA Pattern Marine Helmet", floor(scale * 15), /obj/item/clothing/head/helmet/unsc/variant_2, VENDOR_ITEM_REGULAR),
		list("CH252 Pattern Marine Helmet", floor(scale * 15), /obj/item/clothing/head/helmet/unsc, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/unsc/forecon/populate_product_list(scale)
	listed_products = list(
		list("STANDARD EQUIPMENT", -1, null, null, null),
		list("Marine Combat Boots", floor(scale * 15), /obj/item/clothing/shoes/marine/knife, VENDOR_ITEM_REGULAR),
		list("Marine Uniform", floor(scale * 15), /obj/item/clothing/under/marine/unsc/forecon, VENDOR_ITEM_REGULAR),
		list("Marine Combat Gloves", floor(scale * 15), /obj/item/clothing/gloves/marine, VENDOR_ITEM_REGULAR),
		list("Marine Radio Headset", floor(scale * 15), /obj/item/device/radio/headset/almayer/marine/solardevils, VENDOR_ITEM_REGULAR),
		list("CH299 Pattern Marine Helmet", floor(scale * 15), /obj/item/clothing/head/helmet/unsc/forecon, VENDOR_ITEM_REGULAR),
...
/obj/structure/machinery/cm_vending/sorted/uniform_supply/squad_prep/unsc/odst/populate_product_list(scale)
	listed_products = list(
		...
		list("ARMOR", -1, null, null),
		list("CH381 ODST helmet", floor(scale * 15), /obj/item/clothing/head/helmet/unsc/odst, VENDOR_ITEM_MANDATORY),
