...
/obj/item/storage/large_holster/spnkr
	...
	desc = "A carrying rack complete with two individual cloth bags, each capable of storing one M19 twin-tube unit for the M41 SPNKr, and a special harness for the launcher itself."
	icon = 'icons/halo/obj/items/clothing/back/back_by_faction/back_unsc.dmi'
