...
/obj/item/device/helmet_visor/night_vision/halo/activate_visor(obj/item/clothing/head/helmet/marine/attached_helmet, mob/living/carbon/human/user)
	...
	user.add_client_color_matrix("visr_low_light", 99, color_matrix_multiply(color_matrix_saturation(1.1), color_matrix_from_string("#cab999"))) // saturation originally 0.8, hexcode originally "#cbae77" -> sat 1.25 and #cab999 -> sat 1.1
