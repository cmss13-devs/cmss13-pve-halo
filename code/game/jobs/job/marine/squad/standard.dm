...
/datum/job/marine/standard
	...
	gear_preset_secondary = /datum/equipment_preset/unsc/pfc/private
	gear_preset_tertiary = /datum/equipment_preset/unsc/pfc/lance_corporal
...
/datum/job/marine/standard/ai/rto
	...
	gear_preset_secondary = /datum/equipment_preset/unsc/rto/lance_corporal
	gear_preset_quaternary = /datum/equipment_preset/unsc/rto/pfc
	job_options = list(PFC_VARIANT = "PFC", LCPL_VARIANT = "LCPL", CPL_VARIANT = "CPL")
